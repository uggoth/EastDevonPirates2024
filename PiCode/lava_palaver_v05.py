module_name = 'lava_palaver_v05.py'
# working version 2024/04/xxx
...
# constrain values to aid motor control
    ...
    while course_not_complete:
       ...
       # get line position
        ...
        # calcuate error, which is the centre position less half the line width  plus the line start
            ...
            if line_errorP < 5:
                robot_speed_dynamic = robot_speed + 10
            else:
                robot_speed_dynamic = robot_speed
